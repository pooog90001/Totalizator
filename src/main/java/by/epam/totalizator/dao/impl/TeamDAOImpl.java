...
import by.epam.totalizator.entity.TeamEntity;
...
public class TeamDAOImpl extends TeamDAO {
    ...
    public List<TeamEntity> findAll() throws DAOException {
        ...
        try (PreparedStatement statement = connection.prepareStatement(SQLRequestConstant.FIND_ALL_TEAMS)) {
    ...
    public List<TeamEntity> findBySportId(int sportId) throws DAOException {
        ...
        try (PreparedStatement statement = connection.prepareStatement(SQLRequestConstant.FIND_TEAMS_BY_SPORT_ID)) {
    ...
    public List<Map<String, Object>> findAllWithKindOfSport() throws DAOException {
        ...
        try (PreparedStatement statement = connection.prepareStatement(SQLRequestConstant.FIND_ALL_TEAMS_WITH_KIND_OF_SPORT)) {
            ResultSet resultSet = statement.executeQuery();
            teamList = new ArrayList<>();
