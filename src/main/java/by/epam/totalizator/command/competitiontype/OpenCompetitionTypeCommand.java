package by.epam.totalizator.command.competitiontype;
...
public class OpenCompetitionTypeCommand  extends AbstractCommand{
    private static final Logger LOGGER = LogManager.getLogger();

    public OpenCompetitionTypeCommand(Receiver receiver) {
        super(receiver);
    }
    ...
    public Router execute(RequestContent requestContent) {
        ...
        try {
            ...
            router.setRoutePath(PageType.ADMIN_COMPETITION_TYPE.getPage());
            router.setRouteType(RouteType.FORWARD);

        } catch (ReceiverException e) {
            LOGGER.log(Level.ERROR, "Open comptition type receiver error", e);
