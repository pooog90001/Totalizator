...
import by.epam.totalizator.receiver.UserReceiver;
...
import by.epam.totalizator.util.StringEncoder;
...
import static by.epam.totalizator.constant.GeneralConstant.USER;
import static by.epam.totalizator.constant.GeneralConstant.WRONG_DATA;
import static by.epam.totalizator.constant.RequestNameConstant.*;
import static by.epam.totalizator.constant.RequestNameConstant.NAME;
...
public class UserReceiverImpl implements UserReceiver {
    ...
    public void addMoney(RequestContent content) throws ReceiverException {
        ...
        if (!userValidator.isCashValid(cash)) {
            content.getAjaxResult().add(WRONG_DATA, new Gson().toJsonTree(true));
            content.setAjaxSuccess(false);
            return;
        }
