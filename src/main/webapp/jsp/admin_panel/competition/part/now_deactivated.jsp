...
<div id="NowDeactivated" class="now" style="display:none">

    <c:forEach var="competition" items="${nowDeactiveCompetitions}">
        <div id="nowDeactivatedGame${competition['competition_id']}"
                        ...
                        <div class="w3-row">
                            <div class="w3-half">
                                <input onclick="(dmodal_del${competition['competition_id']}).style.display='none';
                                        delUnfilled(this, 'nowDeactivatedGame'+${competition['competition_id']});"
...
<%--<script src="${pageContext.request.contextPath}/js/competition_now.js"></script>--%>
